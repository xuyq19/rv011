...
- [移植设计文档](docs/设计文档.md)：架构、内存/陷阱/系统调用/文件系统设计，
  以及移植过程中修掉的经典坑。
- [修改点记录](docs/修改点.md)：逐条对照官方 0.11 源码的修改点与原因。
- [移植步骤](docs/移植步骤.md)：按阶段记录“怎么一步一步移植”的完整过程
  与每个阶段的验证方法、踩坑记录。
- [功能与压力测试指南](docs/测试指南.md)：每个测试程序的用途、命令、
  预期输出与长时间 soak 方法。
